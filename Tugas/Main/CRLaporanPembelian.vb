...
Public Class CRLaporanPembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Main.CRLaporanPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLaporanPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLaporanPembelian = New CRLaporanPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
