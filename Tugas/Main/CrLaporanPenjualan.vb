...
Public Class CrLaporanPenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Main.CrLaporanPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLaporanPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLaporanPenjualan = New CrLaporanPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
