...
Public Class CrLaporanMutasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Main.CrLaporanMutasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLaporanMutasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLaporanMutasi = New CrLaporanMutasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
